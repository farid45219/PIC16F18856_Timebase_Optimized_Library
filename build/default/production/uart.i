...
# 53 "C:/Program Files/Microchip/MPLABX/v5.50/packs/Microchip/PIC16F1xxxx_DFP/1.7.146/xc8\pic\include\proc\pic16f18856.h"
...
UART.RxPort=0x01;
UART.RxPin=6;
for(uint8_t i=0;i<64;i++){UART.Buffer[i]=0;}
UART.BufferIndex=0;
}
...
if (UART.TxPin==0){RA0PPS=0x10;}
else if(UART.TxPin==1){RA1PPS=0x10;}
else if(UART.TxPin==2){RA2PPS=0x10;}
else if(UART.TxPin==3){RA3PPS=0x10;}
else if(UART.TxPin==4){RA4PPS=0x10;}
else if(UART.TxPin==5){RA5PPS=0x10;}
else if(UART.TxPin==6){RA6PPS=0x10;}
else if(UART.TxPin==7){RA7PPS=0x10;}
}
else if(UART.TxPort==0x01){
TRISB|=(uint8_t)(1<<UART.TxPin);
ANSELB&=(uint8_t)(~(1<<UART.TxPin));
if (UART.TxPin==0){RB0PPS=0x10;}
else if(UART.TxPin==1){RB1PPS=0x10;}
else if(UART.TxPin==2){RB2PPS=0x10;}
else if(UART.TxPin==3){RB3PPS=0x10;}
else if(UART.TxPin==4){RB4PPS=0x10;}
else if(UART.TxPin==5){RB5PPS=0x10;}
else if(UART.TxPin==6){RB6PPS=0x10;}
else if(UART.TxPin==7){RB7PPS=0x10;}
}
else if(UART.TxPort==0x02){
TRISC|=(uint8_t)(1<<UART.TxPin);
ANSELC&=(uint8_t)(~(1<<UART.TxPin));
if (UART.TxPin==0){RC0PPS=0x10;}
else if(UART.TxPin==1){RC1PPS=0x10;}
else if(UART.TxPin==2){RC2PPS=0x10;}
else if(UART.TxPin==3){RC3PPS=0x10;}
else if(UART.TxPin==4){RC4PPS=0x10;}
else if(UART.TxPin==5){RC5PPS=0x10;}
else if(UART.TxPin==6){RC6PPS=0x10;}
else if(UART.TxPin==7){RC7PPS=0x10;}
}
TX1STA |= (1<<5);
RC1STA |= (1<<7);
}
...
RXPPS=(uint8_t)UART.RxPin;
}
else if(UART.RxPort==0x01){


RXPPS=(uint8_t)(UART.RxPin+0x08);
}
else if(UART.RxPort==0x02){


RXPPS=(uint8_t)(UART.RxPin+0x10);
}
RC1STA |= (1<<4);
RC1STA |= (1<<7);
}
...
UART.BufferIndex++;
if(UART.BufferIndex>=64){UART.BufferIndex=0;}
}
}
}
